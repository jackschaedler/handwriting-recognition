...
function update()
{
  ...
  var thinned_contour_points = vis.selectAll(".thinned_contour_points").data(grail.ThinnedCurvature());
...
var helpIcon = d3.select('#thinned_curvature_wrapper').append("span")
